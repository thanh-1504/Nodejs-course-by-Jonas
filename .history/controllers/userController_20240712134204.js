...
// Được lưu vào ổ đĩa (Nếu như k cần resize image của user sau khi dc upload lên thì xài disStorage )
...
// Được lưu vào ô nhớ cụ thể là buffer (Nếu như cần resize image thì lưu vào bộ nhớ buffer)
const multerStorage = multer.memoryStorage();

const multerFilter = (req, file, cb) => {
  if (file.mimetype.startsWith("image")) cb(null, true);
  else cb(throw new AppError("Not an image! Please upload only images", 400), false);
};
